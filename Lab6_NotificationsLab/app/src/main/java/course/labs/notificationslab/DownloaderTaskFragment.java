...
public class DownloaderTaskFragment extends Fragment {
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        @Override
        protected String[] doInBackground(ArrayList<Integer>... feeds) {
            ArrayList<Integer> incomingFeeds = feeds[0];
            Integer[] twitters = new Integer[incomingFeeds.size()];
            int i = 0;
            for (Integer twittee : incomingFeeds) {
                twitters[i] = twittee;
                i++;
            }
            return downloadTweets(twitters);
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (getResultCode() != MainActivity.IS_ALIVE) {
                            ...
                            notificationBuilder.setTicker("Download completed!")
